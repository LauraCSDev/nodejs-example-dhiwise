...
router.route('/client/api/v1/user/softDeleteMany').put(auth(...[ 'softDeleteManyByUserInClientPlatform' ]),checkRolePermission,userController.softDeleteManyUser);
...
router.route('/client/api/v1/user/deleteMany').post(auth(...[ 'deleteManyByUserInClientPlatform' ]),checkRolePermission,userController.deleteManyUser);
router.route('/client/api/v1/user/softDelete/:id').put(auth(...[ 'softDeleteByUserInClientPlatform' ]),checkRolePermission,userController.softDeleteUser);
...
router.route('/client/api/v1/user/delete/:id').delete(auth(...[ 'deleteByUserInClientPlatform' ]),checkRolePermission,userController.deleteUser);
