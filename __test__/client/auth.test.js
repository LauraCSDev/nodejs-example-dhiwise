...
beforeAll(async function (){
  try {
    ...
    inserted_user = await user.insertOne({
      firstName: 'Ms. Sean Crooks',
      lastName: 'Angelo Kessler',
      name: 'Emmett Yundt',
      username: 'Taryn_Trantow',
      password: 'BSboXJ4LdLAuXqD',
      email: 'Kristina.Upton@yahoo.com',
      mobileNo: '948.866.3542',
      role: 312,
      resetPasswordLink: {},
      loginRetryLimit: 784,
      loginReactiveTime: '2022-11-05T11:58:43.935Z',
      id: '620594c1bd55e395cda4c6b9'
    });
  }
  catch (err) {
...
describe('POST /register -> if email and username is given', () => {
  test('should register a user', async () => {
    let registeredUser = await request(app)
      ...
      .send({
        'firstName':'Patti Sanford',
        'lastName':'Jacqueline Hodkiewicz',
        'name':'Ian Schmeler',
        'username':'Ignacio.Turcotte',
        'password':'TzKNP5El8vayYJg',
        'email':'Joannie_Hayes@hotmail.com',
        'mobileNo':'704.942.5851 x4994',
...
describe('POST /forgot-password -> if email passed from request body is valid and OTP sent successfully', () => {
  test('should return success message', async () => {
    ...
    let user = await request(app)
      .post('/client/auth/forgot-password')
      .send({ 'email':'Joannie_Hayes@hotmail.com', });
