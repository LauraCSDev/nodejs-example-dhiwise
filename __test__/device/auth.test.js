...
beforeAll(async function (){
  try {
    ...
    inserted_user = await user.insertOne({
      firstName: 'Loren Mante',
      lastName: 'Julio Brekke',
      name: 'Ms. Randy Corwin',
      username: 'Marquise.Koelpin1',
      password: '8Fk3ojtBldAFPGG',
      email: 'Jessica98@hotmail.com',
      mobileNo: '1-276-818-2740 x576',
      role: 964,
      resetPasswordLink: {},
      loginRetryLimit: 427,
      loginReactiveTime: '2022-03-21T12:15:00.408Z',
      id: '620594c1bd55e395cda4c699'
    });
  }
  catch (err) {
...
describe('POST /register -> if email and username is given', () => {
  test('should register a user', async () => {
    let registeredUser = await request(app)
      ...
      .send({
        'firstName':'Lawrence Herzog',
        'lastName':'Candice Powlowski',
        'name':'Ella Keeling',
        'username':'Corene40',
        'password':'ju0GImVpthT49Ul',
        'email':'Amie_Nienow63@yahoo.com',
        'mobileNo':'(300) 568-1113 x5090',
...
describe('POST /forgot-password -> if email passed from request body is valid and OTP sent successfully', () => {
  test('should return success message', async () => {
    ...
    let user = await request(app)
      .post('/device/auth/forgot-password')
      .send({ 'email':'Amie_Nienow63@yahoo.com', });
